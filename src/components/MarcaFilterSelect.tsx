      ...
      <Tag
        className={
          onHeader
            ? marca
              ? "size-3.5 text-white"
              : "size-3.5 text-[--color-header-fg-dim]"
            : marca
        ...
        className={
          onHeader
            ? marca
              ...
              : "rounded-md border border-white/30 bg-white/10 px-2 py-1 text-[12px] text-[--color-header-fg-muted] outline-none focus:border-white"
            : marca
